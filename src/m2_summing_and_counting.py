...
def run_test_sum_more_cosines():
    ...
    # Test 3:
    expected = -2.077667  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(-42, 42)
...
def run_test_count_sines_from():
    ...
    # Test 1:
    expected = 734
    answer = count_sines_from(-100, 1000)
...
def run_test_count_sines_vs_cosines():
    ...
    # Test 1:
    expected = 38
    answer = count_sines_vs_cosines(37)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    ...
    # Test 2:
    expected = 43
    answer = count_sines_vs_cosines(42)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
