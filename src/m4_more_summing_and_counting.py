...
def run_test_factorial():
 ...
 # Test 5:
    answer_from_formula = 1*2*3*4
    answer_from_my_code = factorial(4)
    print('Test 2 expected (from oracle):', answer_from_formula)
    print('       actual (from my code): ', answer_from_my_code)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 2
    answer = count_cosines_from(0, 4, 0.42)
    ...
    # Test 4:
    expected = 7
    answer = count_cosines_from(3, 9, -10)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 0
    answer = count_cosines_from(-32, 943, 1)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 2
    answer = count_cosines_from(1, 5, 0.14)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 13/12  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(2, 4)
